KPI Definitions, AXIOM Band Placement, Review Input/Output & Management Tracking Framework

**Prepared For: Mareenraj (Technical Team)**  
 Prepared By: Implementation Officer
...
low ROI contribution, low NNV growth and poor utilization.
...
AXIOM Score, AXIOM Band, NNV Band, Risk Level, Coaching Requirement, Training Requirement,  
 Warning Status, PIP Status, Bonus Eligibility, Promotion Candidate Status.

# **6\. Weekly AXIOM Workflow**

Collect data weekly, calculate KPI scores, assign bands, identify risks,  
 conduct management review, issue action plans and monitor outcomes.

# **7\. Incident Management & Escalation**

Week 1 Coaching, Week 3 Additional Support, Week 5 First Warning,  
 Week 7 Second Warning, Week 8 Third Warning \+ PRC Review.  
 Incident Count: 1 Coaching, 2 Observation, 3 Escalation, 4 Final Warning, 5+ PRC Action.

# **8\. PRC Governance**

Performance Review Committee Members:  
 Managing Director, Implementation Officer, Admin Manager, Team Leader,Operational manager  
 Responsibilities: KPI Review, Bonus Approval, Escalation Decisions, Promotion Reviews.

# **9\. Bonus Eligibility**

YOY Growth \>=30%, ROAS/ACOS Target Achieved, Individual Staff Net Sales at Green Band or Above,  
 No Active Incident Reports, Documentation Compliance \>=90%, Positive ROI, PRC Approval.
