...
| Management Action Records Reading Rule — relationship to MD discussion notes | intelligence-inbox/raw-stakeholder-documents/md-discussion-notes/ is the historical source layer (SRC-MD-HR-001, SRC-MD-SUMAN-001, SRC-MD-ARUN-001); management-action-records/ is the ongoing intelligence input layer; these are distinct and must not be conflated | SRC-MD-HR-001, SRC-MD-SUMAN-001, SRC-MD-ARUN-001, MGMT-ACTION-RECORDS-FOLDER | CONFIRMED | — | context/management-action-records-context.md Relationship Between Folders section |
...
| Source IDs Used | SRC-MD-ARUN-001 READY — Varmen Reviewed by project default | evidence/source-register.md | CONFIRMED — 2026-06-26 | — | Registered as READY Current Evidence Source; spans 24/06/2025–25/06/2026; sensitivity: INTERNAL/RESTRICTED; no personal case details cited in context files |
| Problem Type 3 — LLM-Queryable Compliance Gap | Bonus eligibility for Sales Team contingent on LLM-queryable documentation; Auditor verifies compliance | SRC-MD-ARUN-001 | CONFIRMED — Varmen Reviewed by project default 2026-06-26 | — | SRC-MD-ARUN-001 22/06/2026; soft conflict with SRC-ARUN-001 §9 noted — Varmen integration confirmation recommended; see validation/md-arun-discussion-conflict-check.md |
| Problem Type 3 — LLM-Queryable Compliance Gap | Queryability scoring: 5 = fully queryable; 1-4 = partially; 0 = not queryable but skill documented; −1 to −5 = not queryable and skill missing | SRC-MD-ARUN-001 | CONFIRMED — Varmen Reviewed by project default 2026-06-26 | — | SRC-MD-ARUN-001 25/06/2026; provides specific scoring standard for LLM-queryability compliance checks |
| Problem Type 6 — KPI Review Preparation Gap | KPI meeting format: 5-minute per person limit, KPI Time Index, weekly scores, post-meeting self-recording, self-evaluation, discussion quality | SRC-MD-ARUN-001 | CONFIRMED — Varmen Reviewed by project default 2026-06-26 | — | SRC-MD-ARUN-001 24/06/2025, 10/07/2025; supplements SRC-ARUN-001 KPI definitions with meeting format governance detail |
| Problem Type 11 — Management File Organization Gap | Meeting ID system: unique Meeting ID per meeting; Main ID and Sub IDs per point; required metadata | SRC-MD-ARUN-001 | CONFIRMED — Varmen Reviewed by project default 2026-06-26 | — | SRC-MD-ARUN-001 19/06/2026; supplements SRC-MD-HR-001 Task ID Standard; distinct — Meeting IDs for meeting management, Task IDs for task tracking |
| Problem Type 11 — Management File Organization Gap | BGCT documentation hierarchy: BGCT → Handbook → Skill file → Rule book; BGCT must include create date and creation owner | SRC-MD-ARUN-001 | CONFIRMED — Varmen Reviewed by project default 2026-06-26 | — | SRC-MD-ARUN-001 26/05/2026; supplements SRC-MD-HR-001 BGCT central storage governance |
| VERIFY check items 8, 9, 10 | Checked against SRC-MD-ARUN-001; no evidence found for items 8 (Amazon ACOS) or 9 (Operational Manager PRC); item 10 (ROI Officer) has partial support (Mayurika ROI coordination confirmed but title not used); all three retained as [VERIFY] | SRC-MD-ARUN-001 | NO EVIDENCE / PARTIAL — VERIFY RETAINED | YES | Items 8, 9, 10 in verify-register.md; see validation/md-arun-discussion-impact-map.md |
| Wrapper — SRC-MD-ARUN-001 note | Skill wrapper update RECOMMENDED to add SRC-MD-ARUN-001 to Source IDs Used table and extend Problem Types 3, 6, 11 — not yet applied; pending Varmen approval | SRC-MD-ARUN-001 | RECOMMENDED — NOT YET APPLIED | — | See validation/md-arun-discussion-impact-map.md §Wrapper Recommendation |
...
**Update note (2026-06-25 — SRC-SUMAN-002):** 6 rows added for SRC-SUMAN-002 historical gap evidence integration. All 6 rows CONFIRMED. No [VERIFY] items changed. 12 open [VERIFY] items remain unchanged.

**Update note (2026-06-26 — SRC-MD-ARUN-001):** 9 rows added for SRC-MD-ARUN-001 integration: source ID registration, Problem Types 3/6/11 new evidence rows, VERIFY check result for items 8/9/10, and wrapper update recommendation note. SRC-MD-ARUN-001 confirmed as READY — Varmen Reviewed by project default. No [VERIFY] items resolved. All 12 open [VERIFY] items remain unchanged. Skill wrapper update is RECOMMENDED but not yet applied — pending Varmen approval. Total rows updated to approximately 139.
